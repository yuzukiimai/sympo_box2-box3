...
ただし，開発したシステムは ROS 1 のパッケージで構成されており，
ROS 1は，Noetic のリリースを最後に2025年で開発サポートが終了するという問題がある．
サポートが終了すると，新たなシステムが開発できなくなるため，
早急に現在の ROS 1 のシステムを ROS 2 のシステムへ移行させることが必要であった．

よって，box3 チームは現在のシステムを ROS 2に移行し，信号付近までロボットを自律走行させることを目標とした．
本年度の取り組みを以下で紹介する．

\subsubsection{システムの ROS 2 移行}
