...
ここで，検証結果の一例を\figref{fig:test1}，\figref{fig:test2}に示す．
\figref{fig:test1}のように，青信号と赤信号のどちらも高い正確度で認識できた．
ただし，認識後のロボットの行動プログラムは作成できなかったため，来年度に行う予定である．
...
\figref{fig:box3-human}に示すようにロボットの前方に人がいた．
前の人をコストと認識し，ロボットがその場で停止した．
その後，コストが消えて移動を始めようとするが，周囲の人だかりと植木が誤ってマッチングし，
進入禁止エリアに自己位置が飛んだ．これにより，経路追従行動を継続できなくなったと考えられる．
また，ホイールオドメトリが正確ではなく，スキャンのデータの信頼度が大きかったため，このような
ことが起こった．この解決策としては，IMU を搭載し，複数のセンサ情報を統合することで防ぐことが
できるのではないかと考えられる．
