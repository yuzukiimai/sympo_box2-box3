...
\vspace*{-1mm}次に，これらの課題を達成するために取り組んだ内容を以下に述べる．
...
集荷ボックスと宅配ボックスの認識には，YOLOv5を用いた．YOLOは画像を入力すると，対象とした物体が
画像中のどこにあるかを表すバウンディングボックスと認識率を出力する．データセットは，自作のものを使用した．
学習のために？枚の画像からなるデータセットを作成し，そのうちの？枚を訓練，？枚を検証に用いた．
自作のデータセットは，ボックス 2つ(集荷，宅配)と配達先 3つ(a,b,c)の計5 クラスでアノテーションをした．
