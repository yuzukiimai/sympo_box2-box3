...
さらに，道幅の狭い経路を通る必要があるため，完走するにはよりロバストなシステムが要求された．
...
合計2287個のデータセットを作成し，そのうちの2261個を訓練用，を26個を検証用とした．
...
%他も具体的にお願いします。 内輪の話なので多分他の人が見ても意味がわかりません。 by今井
本課題は，コースの途中の公園で行うため，ゴールまで設定したwaypointを一度外れる必要がある．
本チームが用いている waypointパッケージである waypoint\_managerから，ナビゲーションに用いる設定した
waypointに従うかを判断する．これはwaypointの個数により判断され，指定のwaypoint数に達すると，
%----------------------------------------------------------------------------------------------------------
...
ただし，本システムは検証段階であったため，本走行での使用には至っていない．
